...
?>
	<?php if(isset($_SESSION['user_info']) && is_array($_SESSION['user_info'])) { ?>
	    ...
	    <form id="login-form" class="login-form" name="form1">
	        ...
	        <div id="form-content">
	            <div class="welcome" align="center"><br>
					<?php echo $_SESSION['user_info']['name']  ?>, you are logged in. 
                    <br /><br />
                    <?php echo $_SESSION['user_info']['content']  ?>
                    <br /><br />
					<a href="property-search.php" style="color:#F9F004">Go to PROPERTY Search</a><br><br>
                    <a href="index.php?ac=logout" style="color:#07F7FB">Logout</a>
				</div>	
	        </div>
	...
	<?php } else { ?>
	    <form id="login-form" class="login-form" name="form1" method="post" action="index.php">
	        ...
	        <div class="h1">Contractor Login</div>
	        <div id="form-content">
	            <div class="group">
