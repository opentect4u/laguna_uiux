...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-qrcode fa-fw"></i> QR Codes</b></h5>
  </header>
	<div class="w3-container w3-light-grey w3-padding-32">
	  ...
	  Shown below is a copy of the Menu QR Code we have generated for display in your Restaurant.<br><br>
	  
	  <img src="images/the_cliff_qr-code-dining.png" width="50%" length="auto">
	  ...
	  Link : <a href="https://www.mifrends.com/platform/restaurant_portal/qrc-creator.php">QR Code Generator</a> 
	  </p>
		</div>
