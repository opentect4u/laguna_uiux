...
<!--<div class="row">
  ...
  <div class="column middle" style="background-color:">
	 <form action="rest-account.php" method="post">
  ...
  <div class="container">
	...
	<label for="psw" class="forgotPass"><a href="forgetpass.php">Forgot Password</a></label>  
	<label for="psw" class="siginUp"><a href="/lagunaResturant/register.html">Sign Up / Register</a></label> 
