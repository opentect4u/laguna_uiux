...
<h5><b><i class="fa fa-users"></i> Promotions</b></h5>
</header>
...
<div class="w3-row-padding" style="margin:0 25px">
	...
	<p>These are the default components that make up the Birthday/Anniversary promotion and this is where you can change them.<br>
		<br>Restaurants can amend those components whenever they want from their own platform. </p>
...
<div id="Intro" class="tabcontent">
  ...
  <form action="">
		...
		<br>	  
		This is the default email that's sent to a customer who registers for the Birthday/Anniversary Offer. It also qualifies them for a Free Offer<br> 
		<br>
...
<div id="Image" class="tabcontent"><br>
	  
			  <strong>STOCK IMAGES</strong>- These are the images that are offered to Restaurants to be placed as the top of the Promotion popup. You can add to this gallery at anytime by uploading them below:<br>
	  		<br>Please check that the image you're about to upload meets our requirements as the change will take effect immediately.<br>This should be in JPG or PNG format and roughly 600 x 200 px<br>
	 		 <br>
	  			<form action="">
...
<div id="Offer" class="tabcontent">
	...
	<br>
	These are the default settings for the promotion. They can be changed by completign the 'Update' section.
    <form action="">
	...
	<br>The default questions of First Name, Last Name, Email, Birthday Date, Anniversary Date and Moble cannot be changed.<br>
		<br>Admin can add additonal questions but these would be global, ie. on ALL restaurant's promotions.<br>
  ...
  <form action="">
		...
		<br>	  
		This is the default email that's sent to a customer around two weeks before their Birthday/Anniversary.<br>
	    You can change this message using the Update box and once saved it will be displayed on ALL Restaurants unless they have amended the message themselves.<br><br>
	    <div class="form-inline">
			
		<label>Mailing Email (current)
		<textarea name="introduction" maxlength="500" rows="6" cols="25" readonly>
Hello [name from registration]!
