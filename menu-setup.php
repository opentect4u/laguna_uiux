...
After we set-up your platform the first time, you can then browse and change photos and edit your menu items and pricing, as needed. The Cover Image is non-editable.<br><br>
	...
	<div class="secDifer">
		<label class="titleCustom"><strong>COVER PAGE IMAGE (non editable)</strong></label>
	  Upload an image for your Breakfast Menu cover page.<br>This will be used for your online menu, and used for the background image for your Menu QR Code signage.
	  <form action="">
  <label for="myfile">Select file/s:</label>
  <input type="file" id="myfile" name="myfile" multiple><br>
</form><br>Or, we can collect a photo found on your web site and add it as your background Breakfast menu image.
	<form>
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
	...
	<p style="font-style: italic">If we cannot collect the photos from your web site, we will contact you</p>
	  ...
	  <div class="secDifer">
	 <label class="titleCustom"><strong>TOP IMAGE</strong></label>
	  This image will be added to the top of your Breakfast menu.<br>
		<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Photo File</strong></label><br>
	  <form action="">
  <label for="myfile">Upload 1 Breakfast JPG or PNG images:</label><br>
  <input type="file" id="myfile" name="myfile" multiple><br><br>
	<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Your Web Site Address/URL:</strong></label><br>	  
</form>Or, we can collect a photo found on your web site and add it to the top of your Breakfast menu:
	<form>
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
</form> 
	<p style="font-style: italic">If we cannot collect the photos from your web site, we will contact you</p>
  ...
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
	...
	<?php /*?><div class="secDifer">
	<label class="titleCustom"><strong>DISPLAY DAY &AMP; TIMES:</strong></label>
	Your "dynamic" Menu will automatically change to your breakfast menu, based on your day/time of day instructions below.<br>

	Select the days and times to display your Breakfast menu, every week:<br><br>
...
<input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
  <label for="vehicle1"> Every Day</label></div>
	<div class="startEnd">
	...
	<div class="dayTime">
		<div class="dayCheckBox">
	<input type="checkbox" id="Monday" name="vehicle2" value="Car">
  <label for="Monday"> Monday</label> 
	...
	<div class="dayTime">
		<div class="dayCheckBox">
<input type="checkbox" id="Tuesday" name="vehicle3" value="Boat">
	...
	<div class="dayTime">
	<div class="dayCheckBox">
<input type="checkbox" id="Wednesday" name="vehicle1" value="Bike">
  <label for="Wednesday"> Wednesday</label>
	...
	<div class="dayTime">
	<div class="dayCheckBox">
<input type="checkbox" id="Thursday" name="vehicle2" value="Car">
  <label for="Thursday"> Thursday</label>
	...
	<div class="dayTime">
	<div class="dayCheckBox">
<input type="checkbox" id="Friday" name="vehicle3" value="Boat">
  <label for="Friday"> Friday</label>
	...
	<div class="dayTime">
	<div class="dayCheckBox">
<input type="checkbox" id="Saturday" name="saturday" value="Bike">
  <label for="Saturday"> Saturday</label>
	...
	<div class="dayTime">
	<div class="dayCheckBox">
<input type="checkbox" id="Sunday" name="vehicle2" value="Car">
...
After we set-up your platform the first time, you can then browse and change photos and edit your menu items and pricing, as needed. The Cover Image is non-editable.<br><br>
	...
	<div class="secDifer">
		<label class="titleCustom"><strong>COVER PAGE IMAGE (non editable)</strong></label>
	  Upload an image for your Lunch Menu cover page.<br>This will be used for your online menu, and used for the background image for your Menu QR Code signage.
	  <form action="">
  <label for="myfile">Select file/s:</label>
  <input type="file" id="myfile" name="myfile" multiple><br>
</form><br>Or, we can collect a photo found on your web site and add it as your background Lunch menu image.
	<form>
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
</form> 
	<p style="font-style: italic">If we cannot collect the photos from your web site, we will contact you</p>
	...
	<div class="secDifer">
		<label class="titleCustom"><strong>TOP IMAGE</strong></label>
	  This image will be added to the top of your Lunch menu.<br>
		<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Photo File</strong></label><br>
	  <form action="">
  <label for="myfile">Upload 1 Lunch JPG or PNG images:</label><br>
  <input type="file" id="myfile" name="myfile" multiple><br><br>
	<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Your Web Site Address/URL:</strong></label><br>	  
</form>Or, we can collect a photo found on your web site and add it to the top of your Lunch menu:
	<form>
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
</form> 
	<p style="font-style: italic">If we cannot collect the photos from your web site, we will contact you</p>
	...
	<?php /*?><div class="secDifer">
		<label class="titleCustom"><strong>SECTION IMAGES</strong></label>
	  Add one image for each Section on your Lunch menu.<br>
		<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Photo File</strong></label><br>
	  <form action="">
  <label for="myfile">Upload Section images JPG or PNG:</label><br>
  <input type="file" id="myfile" name="myfile" multiple><br><br>
	<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Your Web Site Address/URL:</strong></label><br>	  
</form>Or, we can collect the photos found on your web site and add them to the Sections on your Lunch menu:
	<form>
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
</form> 
	<p style="font-style: italic">If we cannot collect the photos from your web site, we will contact you</p> 
	...
	<div class="secDifer">
		<label class="titleCustom"><strong>MENU:</strong></label>
	  Upload a PDF file of your Lunch menu.<br>
	Please be sure to include your Kids, Desert and Beverage menus, if you have one.<br>
		<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>File (you can add multiple files)</strong></label><br>
	<input type="file" id="myfile" name="myfile" multiple><br><br>
  ...
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
	...
	Your "dynamic" Menu will automatically change to your Lunch menu, based on your day/time of day instructions below.<br>

	Select the days and times to display your Lunch menu, every week:<br><br>
	<form class="form-inline" action="">
	<div class="dayTime">
	<div class="dayCheckBox">
<input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
...
After we set-up your platform the first time, you can then browse and change photos and edit your menu items and pricing, as needed. The Cover Image is non-editable.<br><br>
		...
		<div class="secDifer">
		<label class="titleCustom"><strong>COVER PAGE IMAGE (non editable)</strong></label>
	  Upload an image for your Dinner Menu cover page.<br>This will be used for your online menu, and used for the background image for your Menu QR Code signage.
	  <form action="">
  <label for="myfile">Select file/s:</label>
  <input type="file" id="myfile" name="myfile" multiple><br>
</form><br>Or, we can collect a photo found on your web site and add it as your background Dinner menu image.
	<form>
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
</form> 
	<p style="font-style: italic">If we cannot collect the photos from your web site, we will contact you</p>
	 ...
	 <div class="secDifer">
		<label class="titleCustom"><strong>TOP IMAGE</strong></label>
	  This image will be added to the top of your Dinner menu.<br>
		<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Photo File</strong></label><br>
	  <form action="">
  <label for="myfile">Upload 1 Dinner JPG or PNG images:</label><br>
  <input type="file" id="myfile" name="myfile" multiple><br><br>
	<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Your Web Site Address/URL:</strong></label><br>	  
</form>Or, we can collect a photo found on your web site and add it to the top of your Dinner menu:
	<form>
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
</form> 
	<p style="font-style: italic">If we cannot collect the photos from your web site, we will contact you</p>
	...
	<?php /*?><div class="secDifer">
		<label class="titleCustom"><strong>SECTION IMAGES</strong></label>
	  Add one image for each Section on your Dinner menu.<br>
		<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Photo File</strong></label><br>
	  <form action="">
  <label for="myfile">Upload Section images JPG or PNG:</label><br>
  <input type="file" id="myfile" name="myfile" multiple><br><br>
	<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Your Web Site Address/URL:</strong></label><br>	  
</form>Or, we can collect the photos found on your web site and add them to the Sections on your Dinner menu:
	<form>
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
</form> 
	<p style="font-style: italic">If we cannot collect the photos from your web site, we will contact you</p>
	...
	<div class="secDifer">
		<label class="titleCustom"><strong>MENU:</strong></label>
	  Upload a PDF file of your Dinner menu.<br>
	Please be sure to include your Kids, Desert and Beverage menus, if you have one.<br>
		<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>File (you can add multiple files)</strong></label><br>
	<input type="file" id="myfile" name="myfile" multiple><br><br>
  ...
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
	...
	<?php /*?><div class="secDifer">
		<label class="titleCustom"><strong>DISPLAY DAY &amp; TIMES:</strong></label>
	Your "dynamic" Menu will automatically change to your Dinner menu, based on your day/time of day instructions below.<br>

	Select the days and times to display your Dinner menu, every week:<br><br>
	<form class="form-inline" action="">
	<div class="dayTime">
	<div class="dayCheckBox">
<input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
...
<div class="secDifer">
		<label class="titleCustom"><strong>COVER PAGE IMAGE (non editable)</strong></label>
	  Upload an image for your Brunch Menu cover page.<br>
	  <form action="">
  <label for="myfile">Select file/s:</label>
  <input type="file" id="myfile" name="myfile" multiple><br>
</form><br>Or if you would like us to select an image for you, please provide a web site address/url where we can collect your menu content.
	<form>
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
</form> 
	<p style="font-style: italic">If we cannot collect the photos from your web site, we will contact you</p>
...
<div class="secDifer">
		<label class="titleCustom"><strong>TOP IMAGE</strong></label>
	  This image will be added to the top of your Brunch menu.<br>
		<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Photo File</strong></label><br>
	  <form action="">
  <label for="myfile">Upload 1 Brunch JPG or PNG images:</label><br>
  <input type="file" id="myfile" name="myfile" multiple><br><br>
	<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Your Web Site Address/URL:</strong></label><br>	  
</form>Or, we can collect a photo found on your web site and add it to the top of your Brunch menu:
	<form>
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
</form> 
	<p style="font-style: italic">If we cannot collect the photos from your web site, we will contact you</p>
	...
	<?php /*?><div class="secDifer">
		<label class="titleCustom"><strong>SECTION IMAGES</strong></label>
	  Add one image for each Section on your Brunch menu.<br>
		<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Photo File</strong></label><br>
	  <form action="">
  <label for="myfile">Upload Section images JPG or PNG:</label><br>
  <input type="file" id="myfile" name="myfile" multiple><br><br>
	<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>Your Web Site Address/URL:</strong></label><br>	  
</form>Or, we can collect the photos found on your web site and add them to the Sections on your Brunch menu:
	<form>
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
</form> 
	<p style="font-style: italic">If we cannot collect the photos from your web site, we will contact you</p>
	...
	<div class="secDifer">
		<label class="titleCustom"><strong>MENU:</strong></label><br>
	  Upload a PDF file of your Brunch menu
	Please be sure to include your Kids, Desert and Beverage menus, if you have one.<br>
		<input type="checkbox" id="menuImg" name="menuImg" value="menuImg">
  <label for="menuImg"> <strong>File (you can add multiple files)</strong></label><br>
	<input type="file" id="myfile" name="myfile" multiple><br><br>
  ...
  <label for="url">Enter the url:</label> <input type="text" id="url" name="url" value="" size="28">
	...
	<?php /*?><div class="secDifer">
		<label class="titleCustom"><strong>DISPLAY DAY & TIMES:</strong></label>
	Your "dynamic" Menu will automatically change to your Brunch menu, based on your day/time of day instructions below.<br>

	Select the days and times to display your Brunch menu, every week:<br><br>
...
document.getElementById("defaultOpen").click();
  ...
  <?php /*?><div class="w3-container w3-half w3-cell w3-mobile">
	<div class="logoRightSec">
