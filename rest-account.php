...
function msg() {
...
</script>Sahim Zaza</td>
    <td>Zaza Johnson &amp; Bath</td>
    <td>41 St John's Hill</td>
    <td>Shrewsbury</td>
    <td>SY1 1JQ</td>
  </tr>
</table> <br>
  ...
  <tr>
    <th scope="col">WEBSITE</th>
    <th scope="col">EMAIL</th>
    <th scope="col">WORK TEL</th>
    <th scope="col">BRANCHES</th>
  </tr>
  <tr bgcolor="#fff" align="center">
    <td bgcolor="#f1f1f1">07973 123456</td>
    <td>gasrenewals@zjandb.com</td>
    <td>01743 248351</td>
    <td>1</td>
  </tr>
</table> <br>
  ...
  <tr bgcolor="#fff" align="center">
    <td>Renewals due in the next 30 days</td>
...
function msg() {
  ...
  <tr bgcolor="#fff" align="center">
    <td>Outstanding certificates </td>
...
function msg() {
  ...
  <tr bgcolor="#fff" align="center">
    <td>Reminders sent in last 7 days</td>
    <td bgcolor="#f1f1f1"><form>
  <input type="button" value="EXCEL" onclick="msg()">
</form>
